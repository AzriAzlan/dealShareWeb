        ...
        <div class="row" style="height: 100%;">
          <div class="col-2 text-white" style="height: 100%; background-color: #CAF0F8; display: flex; flex-direction: column; justify-content: center;">
              ...
              <div class="d-flex align-items-start flex-column" style="width: 100%;">
                <button type="button" class="btn btn-light btn-lg btn-block mb-2" style="width: 100%;">Deal Review</button>
                <button type="button" class="btn btn-secondary btn-lg btn-block mb-2" style="width: 100%;">User Management</button>
                <button type="button" class="btn btn-secondary btn-lg btn-block mb-2" style="width: 100%;">Reward Rate</button>
              </div>
          </div>
          <div class="col-9">
